# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_type_check_impl.py (v2.5.2), verbatim except for the
...
#
#   L12: import numpy._core.numeric as _nx
#      -> from . import _rnp_compat as _nx
#   L13: from numpy._core import getlimits, overrides
#      -> from ._rnp_compat import getlimits
from . import _rnp_compat as overrides
#   L14: from numpy._core.numeric import asanyarray, asarray, isnan, zeros
#      -> from ._rnp_compat import asanyarray, asarray, isnan, zeros
#   L15: from numpy._utils import set_module
