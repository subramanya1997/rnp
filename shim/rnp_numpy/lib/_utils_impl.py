# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_utils_impl.py (v2.5.2), verbatim except for the
...
#   L7: from numpy._core import ndarray
#      -> from ._rnp_compat import ndarray
#   L8: from numpy._utils import set_module
