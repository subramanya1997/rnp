# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/recfunctions.py (v2.5.2), verbatim except for the
...
#   L13: from numpy._core.overrides import array_function_dispatch
#      -> from ._rnp_compat import array_function_dispatch
#   L14: from numpy.lib._iotools import _is_string_like
#      -> from rnp_numpy.lib._iotools import _is_string_like
# ---------------------------------------------------------------------------
"""
