# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_format_impl.py (v2.5.2), verbatim except for the
...
#
#   L169: import numpy
#      -> import rnp_numpy as numpy
#   L170: from numpy._utils import set_module
#      -> from ._rnp_compat import set_module
#   L171: from numpy.lib._utils_impl import drop_metadata
#      -> from rnp_numpy.lib._utils_impl import drop_metadata
# ---------------------------------------------------------------------------
"""
