# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_user_array_impl.py (v2.5.2), verbatim except for the
...
#
#   L10: from numpy._core import (
#      -> from ._rnp_compat import (
#   L39: from numpy._core.overrides import set_module
