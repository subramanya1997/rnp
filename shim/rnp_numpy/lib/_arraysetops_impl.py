# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_arraysetops_impl.py (v2.5.2), verbatim except for the
...
#   L21: from numpy._core import overrides
#      -> from . import _rnp_compat as overrides
#   L22: from numpy._core._multiarray_umath import _array_converter, _unique_hash
#      -> from ._rnp_compat import _array_converter, _unique_hash
#   L23: from numpy.lib.array_utils import normalize_axis_index
#      -> from rnp_numpy.lib.array_utils import normalize_axis_index
# ---------------------------------------------------------------------------
"""
