# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_iotools.py (v2.5.2), verbatim except for the
...
#   L9: import numpy._core.numeric as nx
#      -> from . import _rnp_compat as nx
#   L10: from numpy._utils import asbytes, asunicode
