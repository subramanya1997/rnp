# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_function_base_impl.py (v2.5.2), verbatim except for the
...
#   L9: import numpy._core.numeric as _nx
#      -> from . import _rnp_compat as _nx
#   L10: from numpy._core import overrides, transpose
#      -> from ._rnp_compat import overrides, transpose
#   L11: from numpy._core._multiarray_umath import _array_converter
#      -> from ._rnp_compat import _array_converter
#   L12: from numpy._core.fromnumeric import any, mean, nonzero, partition, ravel, sum
#      -> from ._rnp_compat import any, mean, nonzero, partition, ravel, sum
#   L13: from numpy._core.multiarray import (
#      -> from ._rnp_compat import (
#   L21: from numpy._core.numeric import (
#      -> from ._rnp_compat import (
#   L39: from numpy._core.numerictypes import typecodes
#      -> from ._rnp_compat import typecodes
#   L40: from numpy._core.umath import (
#      -> from ._rnp_compat import (
#   L56: from numpy._utils import set_module
#      -> from ._rnp_compat import set_module
#   L59: from numpy.lib._histograms_impl import histogram, histogramdd  # noqa: F401
#      -> from rnp_numpy.lib._histograms_impl import histogram, histogramdd  # noqa: F401
#   L60: from numpy.lib._twodim_base_impl import diag
#      -> from rnp_numpy.lib._twodim_base_impl import diag
#   L5290: arrorder = 'F' if arr.flags.fnc else 'C'
#      -> arrorder = 'F' if (arr.flags.f_contiguous and not arr.flags.c_contiguous) else 'C'
#   L5506: arrorder = 'F' if arr.flags.fnc else 'C'
#      -> arrorder = 'F' if (arr.flags.f_contiguous and not arr.flags.c_contiguous) else 'C'
# ---------------------------------------------------------------------------
import builtins
