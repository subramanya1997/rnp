# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_histograms_impl.py (v2.5.2), verbatim except for the
...
#   L10: from numpy._core import overrides
#      -> from . import _rnp_compat as overrides
#   L347: return np.subtract(a, b, dtype=type(dt))
