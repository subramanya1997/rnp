# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_nanfunctions_impl.py (v2.5.2), verbatim except for the
...
#   L27: import numpy._core.numeric as _nx
#      -> from . import _rnp_compat as _nx
#   L28: from numpy._core import overrides
#      -> from . import _rnp_compat as overrides
#   L29: from numpy.lib import _function_base_impl as fnb
#      -> from rnp_numpy.lib import _function_base_impl as fnb
#   L30: from numpy.lib._function_base_impl import _weights_are_valid
#      -> from rnp_numpy.lib._function_base_impl import _weights_are_valid
# ---------------------------------------------------------------------------
"""
