# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_index_tricks_impl.py (v2.5.2), verbatim except for the
...
#   L7: import numpy._core.numeric as _nx
#      -> from . import _rnp_compat as _nx
#   L9: from numpy._core import linspace, overrides
#      -> from ._rnp_compat import linspace
from . import _rnp_compat as overrides
#   L10: from numpy._core.multiarray import ravel_multi_index, unravel_index
#      -> from ._rnp_compat import ravel_multi_index, unravel_index
#   L11: from numpy._core.numeric import ScalarType, array
#      -> from ._rnp_compat import ScalarType, array
#   L12: from numpy._core.numerictypes import issubdtype
#      -> from ._rnp_compat import issubdtype
#   L13: from numpy._utils import set_module
#      -> from ._rnp_compat import set_module
#   L14: from numpy.lib._function_base_impl import diff
#      -> from rnp_numpy.lib._function_base_impl import diff
# ---------------------------------------------------------------------------
import functools
import math
import sys
