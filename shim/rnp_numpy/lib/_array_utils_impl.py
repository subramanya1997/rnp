# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_array_utils_impl.py (v2.5.2), verbatim except for the
...
#
#   L4: from numpy._core import asarray
#      -> from ._rnp_compat import asarray
#   L5: from numpy._core.numeric import normalize_axis_index, normalize_axis_tuple
#      -> from ._rnp_compat import normalize_axis_index, normalize_axis_tuple
#   L6: from numpy._utils import set_module
