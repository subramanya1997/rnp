# ---------------------------------------------------------------------------
# Ported from upstream numpy lib/_npyio_impl.py (v2.5.2), verbatim except for the
...
#   L17: from numpy._core import overrides
#      -> from . import _rnp_compat as overrides
#   L18: from numpy._core._multiarray_umath import _load_from_filelike
#      -> from ._rnp_compat import _load_from_filelike
#   L19: from numpy._core.multiarray import packbits, unpackbits
#      -> from ._rnp_compat import packbits, unpackbits
#   L20: from numpy._core.overrides import finalize_array_function_like, set_module
#      -> from ._rnp_compat import finalize_array_function_like, set_module
#   L21: from numpy._utils import asbytes, asunicode
#      -> from ._rnp_compat import asbytes, asunicode
# ---------------------------------------------------------------------------
"""
