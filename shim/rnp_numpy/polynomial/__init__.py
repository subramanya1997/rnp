# ---------------------------------------------------------------------------
# Ported from upstream numpy polynomial/__init__.py (v2.5.2), verbatim except for the
...
#
#   L184: from numpy._pytesttester import PytestTester
#      -> PytestTester = None
#   L186: test = PytestTester(__name__)
#      -> test = None
#   L187: del PytestTester
#      -> (removed)
# ---------------------------------------------------------------------------
"""
