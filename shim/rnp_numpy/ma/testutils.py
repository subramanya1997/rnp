# ---------------------------------------------------------------------------
# Ported from upstream numpy ma/testutils.py (v2.5.2), verbatim except for the
...
#   L10: import numpy._core.umath as umath
#      -> from . import _rnp_compat as umath
#   L11: import numpy.testing
#      -> import rnp_numpy.testing
#   L12: from numpy import ndarray
#      -> from rnp_numpy import ndarray
#   L13: from numpy.testing import (  # noqa: F401
#      -> from rnp_numpy.testing import (  # noqa: F401
# ---------------------------------------------------------------------------
