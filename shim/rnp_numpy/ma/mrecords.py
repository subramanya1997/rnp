# ---------------------------------------------------------------------------
# Ported from upstream numpy ma/mrecords.py (v2.5.2), verbatim except for the
...
#   L19: import numpy.ma as ma
#      -> import rnp_numpy.ma as ma
#   L416: self.flags.fnc,
#      -> (self.flags.f_contiguous and not self.flags.c_contiguous),
# ---------------------------------------------------------------------------
