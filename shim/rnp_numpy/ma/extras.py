# ---------------------------------------------------------------------------
# Ported from upstream numpy ma/extras.py (v2.5.2), verbatim except for the
...
#
#   L26: import numpy as np
#      -> import rnp_numpy as np
#   L27: from numpy import array as nxarray, ndarray
#      -> from rnp_numpy import array as nxarray, ndarray
#   L28: from numpy.lib._function_base_impl import _ureduce
#      -> from rnp_numpy.lib._function_base_impl import _ureduce
#   L29: from numpy.lib._index_tricks_impl import AxisConcatenator
#      -> from rnp_numpy.lib._index_tricks_impl import AxisConcatenator
#   L30: from numpy.lib.array_utils import normalize_axis_index, normalize_axis_tuple
#      -> from rnp_numpy.lib.array_utils import normalize_axis_index, normalize_axis_tuple
# ---------------------------------------------------------------------------
"""
